...
match choice:
    case 1:
        print(f"You'r account_balance = 1000.00")
is_running = True
        ...
        case 2:
            try:
                ...
                if withdraw_amount <= 0:
                    ...
                    print("Withdrawal within your account balance")
                else:
        ...
        case 4:
            try:
                ...
                if transfer_amount <= 0:
                    print("Transfer must be more than $0")
                elif transfer_amount > account_balance:
                    print("Transfer within your account balance")
                else:
                    account_balance -= transfer_amount
                    print(f"You've transferred ${transfer_amount:.2f}")
                    print(f"New aacount balance: ${account_balance:.2f}")
            except ValueError:
                print("Enter an amount")
